...
<button className='py-[9px] px-[71px] border border-[#B6B7BC] rounded-[4px] flex items-center justify-center flex-row gap-2'>
    <Image src={google} alt="google" height={24} width={24} className='w-4 h-4' />
...
<Link href="#" className='text-[12px] text-[#474B57] font-medium text-start mb-6'>By creating an account you agree with our Terms of Service, Privacy Policy,
</Link>
...
<Link href="/sign-in" className='text-[14px] font-normal text-[#5C5F6A] mt-6 text-center'>Already have an account? Log in</Link>
